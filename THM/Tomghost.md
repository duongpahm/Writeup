...
![](Tomghost/Screenshot_2026-01-28_at_10.27.46.png)
...
Sau khi clone công cụ khai thác trên Github, ta thực hiện đọc file (`read`) và thực thi mã (`eval`). Với mục tiêu `10.49.157.12` của bạn, cấu trúc lệnh sẽ như sau:![](Tomghost/Screenshot_2026-01-28_at_11.12.22.png)
...
```
![](Tomghost/Screenshot_2026-01-28_at_11.18.26.png)
![](Tomghost/Screenshot_2026-01-28_at_11.19.47.png)
...
![](Tomghost/Screenshot_2026-01-28_at_11.27.24.png)
...
![](Tomghost/Screenshot_2026-01-28_at_11.32.25.png)
...
Bây giờ bạn đang ở user `skyfuck`, hãy thực hiện chuyển đổi sang user `merlin`![](Tomghost/Screenshot_2026-01-28_at_11.34.55.png)
Đầu tiên, ta di chuyển về thư mục gốc, rồi kiểm tra ta thu được flag user đầu tiên
![](Tomghost/Screenshot_2026-01-28_at_11.40.31.png)
...
![](Tomghost/Screenshot_2026-01-28_at_11.50.38.png)
